...
namespace RatRace
{
    public partial class Main : Form
    {
        ...
        private void pictureRat1_Click(object sender, EventArgs e)
        {

        }

        private void pictureRat2_Click(object sender, EventArgs e)
        {
        ...
        private void pictureRat4_Click(object sender, EventArgs e)
        {

        }

        private void pictureRat5_Click(object sender, EventArgs e)
        {
